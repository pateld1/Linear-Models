...
**NOTE**: Question 59a is lacking answers. The derivation for the MLE of the standard deviations ($\sigma_1$ and $\sigma_2$) and correlation ($\rho_{12}$) of the bivariate normal distribution is yet to be finished. 
...
Answer: The probability density function of the bivariate normal distribution is given in the last problem. Then its likelihood function is $$ L = \prod \frac{1}{2\pi \sqrt{\sigma_1^2\sigma_2^2} \sqrt{1-\rho^2_{12}}} \exp\left( -\frac{1}{2(1 - \rho^2_{12})} \left( \left(\frac{(Y_{1i} - \mu_1)^2}{\sigma_1^2}\right) - 2\rho_{12}\left(\frac{Y_{1i} - \mu_1}{\sqrt{\sigma_1^2}}\right)\left(\frac{Y_{2i} - \mu_2}{\sqrt{\sigma_2^2}}\right) + \left(\frac{(Y_{2i} - \mu_2)^2}{\sigma_2^2}\right)\right)\right) $$ 

Take the $\log$ of this function. 
$$ \log L = -n\log(2\pi) - n\log(\sigma_1^2) - n\log(\sigma_2^2) - \frac{n}{2}\log(1-\rho^2_{12}) - \frac{1}{2(1-\rho^2_{12})} \sum \left( \left(\frac{(Y_{1i} - \mu_1)^2}{\sigma_1^2}\right) - 2\rho_{12}\left(\frac{Y_{1i} - \mu_1}{\sqrt{\sigma_1^2}}\right)\left(\frac{Y_{2i} - \mu_2}{\sqrt{\sigma_2^2}}\right) + \left(\frac{(Y_{2i}-\mu_2)^2}{\sigma_2^2}\right)\right) $$ 

Differentiate this function with respect to $\mu_1$, $\sigma_1$, $\mu_2$, $\sigma_2$ and $\rho_{12}$: 
$$ \begin{aligned} 
\frac{\partial \log L}{\partial \mu_1} &= \frac{1}{\sigma_1^2(1-\rho^2_{12})} \sum (Y_{1i} - \mu_1) - \frac{\rho_{12}}{\sigma_1\sigma_2(1-\rho^2_{12})}\sum (Y_{2i} - \mu_2) \\
\frac{\partial \log L}{\partial \sigma_1} &= -\frac{n}{\sigma_1} + \frac{1}{(1-\rho_{12})^2} \left(\frac{ \sum (Y_{1i} - \mu_1)^2}{\sigma_1^3} - \frac{\rho_{12} \sum (Y_{1i} - \mu_1)(Y_{2i} - \mu_2)}{\sigma_1^2\sigma_2}\right) \\  
\frac{\partial \log L}{\partial \mu_2} &= \frac{1}{\sigma^2_2(1-\rho^2_{12})}\sum (Y_{2i} - \mu_2) - \frac{\rho_{12}}{\sigma_1\sigma_2(1-\rho^2_{12})}\sum (Y_{1i} - \mu_1) \\
\frac{\partial \log L}{\partial \sigma_2} &= -\frac{n}{\sigma_2} + \frac{1}{(1 - \rho_{12})^2}\left(\frac{\sum (Y_{2i} - \mu_2)^2}{\sigma_2^3} - \frac{\rho_{12}\sum (Y_{1i} - \mu_1)(Y_{2i}-\mu_2)}{\sigma_1\sigma_2^2}\right) \\ 
\frac{\partial \log L}{\partial \rho_{12}} &= \frac{n\rho_{12}}{1-\rho^2_{12}} + \frac{1}{1-\rho^2_{12}}\sum \left(\frac{Y_{1i}-\mu_1}{\sigma_1}\right)\left(\frac{Y_{2i}-\mu_2}{\sigma_2}\right) - \frac{\rho_{12}}{(1-\rho_{12}^3)^2} \cdot \sum \left( \left(\frac{Y_{1i} - \mu_1}{\sigma_1}\right)^2 - 2\rho_{12} \left(\frac{Y_{1i} -\mu_1}{\sigma_1}\right)\left(\frac{Y_{2i}-\mu_2}{\sigma_2}\right) + \left(\frac{Y_{2i} - \mu_2}{\sigma_2}\right)^2\right)
\end{aligned} $$

Now if the derivative for $\frac{\partial \log L}{\partial \mu_1} = 0$, then 
$$ \begin{aligned}  \frac{1}{\sigma_1^2(1-\rho^2_{12})} \sum (Y_{1i} - \mu_1) - \frac{\rho_{12}}{\sigma_1\sigma_2(1-\rho^2_{12})}\sum (Y_{2i} - \mu_2) &= 0 \\ 
\frac{1}{\sigma_1^2(1-\rho^2_{12})} \sum (Y_{1i} - \mu_1) - \frac{\text{Cov}[Y_1, Y_2]}{\sigma_1^2\sigma_2^2(1-\rho^2_{12})}\sum (Y_{2i} - \mu_2) &= 0 \\ 
\frac{1}{\sigma_1^2(1-\rho^2_{12})} \sum (Y_{1i} - \mu_1) &= \frac{\text{Cov}[Y_1, Y_2]}{\sigma_1^2\sigma_2^2(1-\rho^2_{12})}\sum (Y_{2i} - \mu_2) \\ 
\sum (Y_{1i} - \mu_1) &= \frac{\text{Cov}[Y_1, Y_2]}{\sigma_2^2} \sum (Y_{2i} - \mu_2) \\ &= 
\frac{\sum (Y_{1i} - \mu_1)(Y_{2i} - \mu_2)}{(n-1)\sigma^2_2} \sum (Y_{2i} - \mu_2) \\ &= 
\frac{\sum (Y_{1i} - \mu_1)(Y_{2i} - \mu_2)}{n-1} \frac{n-1}{\sum (Y_{2i} - \mu_2)^2} \sum (Y_{2i} - \mu_2) \\ &= \frac{(\sum (Y_{2i} - \mu_2))^2 \sum (Y_{1i} - \mu_1)}{\sum (Y_{2i} - \mu_2)^2} \\ &= \sum (Y_{1i} - \mu_1) \\ (\sum Y_{1i}) - n\mu_1 &= n\overline{Y}_1 - n\mu_1 \\ \overline{Y}_1 - \mu_1 &= \overline{Y}_1 - \mu_1 \\ \hat{\mu}_1 &= \overline{Y}_1 \end{aligned} $$ 

Similarly, if the derivative for $\frac{\partial \log L}{\partial \mu_2} = 0$, then
$$ \begin{aligned} \frac{1}{\sigma^2_2(1-\rho^2_{12})}\sum (Y_{2i} - \mu_2) - \frac{\rho_{12}}{\sigma_1\sigma_2(1-\rho^2_{12})}\sum (Y_{1i} - \mu_1) &= 0 \\ 
\frac{1}{\sigma^2_2(1-\rho^2_{12})}\sum (Y_{2i} - \mu_2) - \frac{\text{Cov}[Y_1, Y_2]}{\sigma_1^2\sigma_2^2(1-\rho^2_{12})}\sum (Y_{1i} - \mu_1) &= 0 \\ 
\frac{1}{\sigma^2_2(1-\rho^2_{12})}\sum (Y_{2i} - \mu_2) &= \frac{\text{Cov}[Y_1, Y_2]}{\sigma_1^2\sigma_2^2(1-\rho^2_{12})}\sum (Y_{1i} - \mu_1) \\ 
\sum (Y_{2i} - \mu_2) &= \frac{\text{Cov}[Y_1, Y_2]}{\sigma_1^2}\sum (Y_{1i} - \mu_1) \\ 
&= \frac{\sum (Y_{1i} - \mu_1)(Y_{2i} - \mu_2)}{(n-1)\sigma^2_1} \sum (Y_{1i} - \mu_1) \\ &= 
\frac{\sum (Y_{1i} - \mu_1)(Y_{2i} - \mu_2)}{n-1} \frac{n-1}{\sum (Y_{1i} - \mu_1)^2} \sum (Y_{1i} - \mu_1) \\ &= \frac{(\sum (Y_{1i} - \mu_1))^2 \sum (Y_{2i} - \mu_2)}{\sum (Y_{1i} - \mu_1)^2} \\ &= \sum (Y_{2i} - \mu_2) \\ (\sum Y_{2i}) - n\mu_2 &= n\overline{Y}_2 - n\mu_2 \\ \overline{Y}_2 - \mu_2 &= \overline{Y}_2 - \mu_2 \\ \hat{\mu}_2 &= \overline{Y}_2
\end{aligned} $$ 
...
When simplified, this looks like 
$$ \frac{\sum (Y_{1i} - \hat{\mu}_1)^2}{\hat{\sigma}_1^2} - \hat{\rho}_{12} \frac{\sum (Y_{1i} - \hat{\mu}_1)(Y_{2i} - \hat{\mu}_2)}{\hat{\sigma}_1\hat{\sigma}_2} - n(1 - \hat{\rho}_{12}^2) = 0 $$ 
...
When simplified, this looks like 
$$ \frac{\sum (Y_{2i} - \hat{\mu}_2)^2}{\hat{\sigma}_2^2} - \hat{\rho}_{12} \frac{\sum (Y_{1i} - \hat{\mu}_1)(Y_{2i} - \hat{\mu}_2)}{\hat{\sigma}_1\hat{\sigma}_2} - n(1 - \hat{\rho}_{12}^2) = 0 $$ 
...
When simplied, this looks like 
$$ n\hat{\rho}_{12} + (1 + \hat{\rho}^2_{12} \sum \left( \frac{Y_{1i} - \hat{\mu}_1}{\hat{\sigma}_1}\right) \left(\frac{Y_{2i} - \hat{\mu}_2}{\hat{\sigma}_2}\right) - \hat{\rho}_{12}\sum \left( \left( \frac{Y_{1i} - \hat{\mu}_1}{\hat{\sigma}_1}\right)^2 + \left(\frac{Y_{2i} - \hat{\mu}_2}{\hat{\sigma}_2}\right)^2\right) = 0$$ 

The MLE for $\rho_{12}$ is $$ \hat{\rho}_{12} = \frac{\sum (Y_{1i} - \overline{Y}_1)(Y_{2i} - \overline{Y}_2)}{ (\sum (Y_{1i} - \overline{Y}_1)^2)^{\frac{1}{2}}(\sum (Y_{2i} - \overline{Y}_2)^2)^{\frac{1}{2}}} $$ 
