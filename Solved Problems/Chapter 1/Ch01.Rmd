...
```{r}
optimize(typo_llh_fun, 17:19)
```

The maximum is reached when $\beta_1 = 18.99995$ while looking in the scope of $[17,19]$. This corresponds to the estimate found in part (c). 
